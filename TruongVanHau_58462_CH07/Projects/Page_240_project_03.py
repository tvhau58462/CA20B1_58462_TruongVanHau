...
Date: 17/10/2021
Program: Project_03_page_240.py
Problem:
            The Koch snowflake is a fractal shape. At level 0, the shape is an equilateral triangle.
            At level 1, each line segment is split into four equal parts, producing an equilateral bump in the middle of each segment.
            Figure 7-15 shows these shapes at levels 0, 1, and 2.
            ...
            The initial angles are 0, 2120, and 120 degrees.
            ...
            Otherwise, the function draws four fractal lines with one-third of the given distance,
