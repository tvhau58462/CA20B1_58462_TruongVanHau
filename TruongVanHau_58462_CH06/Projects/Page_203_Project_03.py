...
Problem:
              Elena complains that the recursive newton function in Project 2 includes an extra
                ...
                value, which is always the same, when they call this function. Modify the definition of the
                function so that it uses a keyword argument with the appropriate
