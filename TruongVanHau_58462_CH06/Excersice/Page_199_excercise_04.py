...
Date: 23/10/2021
Program: Excercise_04_page_199.py
Problem:
              ...
              The step value is used to move to thenext value in the range.
              The function is applied to each number visited, and the function’s returned value is added to the running total.
